    ...
    <Container maxW="5xl" px={{ base: 6, md: 3 }} py={10}>
      <Stack direction={{ base: 'column-reverse', md: 'row' }}>
        <Stack direction="column" spacing={6}>
          ...
          >
            Whether you need a website for your business, blog, or portfolio, I can help you.
            I am capable of building full-stack web applications with multiple technologies,
            including React, Node.js, Next.js, Laravel and more.
          </Text>
          <HStack spacing={3}>
